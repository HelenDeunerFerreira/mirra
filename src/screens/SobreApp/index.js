...
export default function SobreApp() {
    return (
        <Container>
            ...
            <Texto>O aplicativo foi construído utilizando o Expo, pois considero mais fácil e rápido para testar, além de ter mais experiência prévia com essa ferramenta.</Texto>
            ...
            <Texto>Para que seja possível cadastrar novos pontos de doação e seu nome no ranking sem correr o risco de outro usuário apagar seus cadastros.</Texto>
            ...
            <Pergunta>Para que serve o ranking?</Pergunta>
            <Texto>Para rankear o número de doações das pessoas cadastradas no aplicativo.</Texto>
        </Container>
    )
}